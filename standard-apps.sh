...
function INSTALL_STDSOFTWARE() {
  ...
  sleep 2
  clear
  $ZB -S --noconfirm --needed system-monitoring-center firefox winetricks steam handbrake obs-studio gimp libreoffice-fresh clementine kdenlive aspell-en youtube-dl paperwork terminator
