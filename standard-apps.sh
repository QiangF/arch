...
function INSTALL_STDSOFTWARE() {
  ...
  sleep 2
  clear
  sudo pacman -S --noconfirm --needed firefox steam aspell-en youtube-dl winetricks #terminator handbrake obs-studio gimp libreoffice-fresh clementine kdenlive paperwork
